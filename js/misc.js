...
function createDialog(text, title, confirmText, cancelText, confirm, cancel) {
	...
	$('#alertBox').dialog({ // Creates a dialog box
		show: {effect: "slideDown", duration: 300}, hide: {effect: "slideUp", duration: 300}, resizable: false, draggable: false,
		modal: true, width: 750, position: {my: 'center', at: 'top', of: window}, dialogClass: 'alertBox', title: title,
		buttons: [
			{
				text: confirmText,
